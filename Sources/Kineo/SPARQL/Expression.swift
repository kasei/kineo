...
public class ExpressionEvaluator {
    ...
    public typealias AlgebraEvaluator = (Algebra, Term) throws -> AnyIterator<SPARQLResult<Term>>
...
//        throw QueryError.evaluationError("Unrecognized numeric function: \(numericFunction)")
    ...
    public func evaluate(expression: Expression, result: SPARQLResult<Term>, activeGraph: Term, existsHandler: @escaping AlgebraEvaluator) throws -> Term {
    ...
    public func evaluate(expression: Expression, result: SPARQLResult<Term>) throws -> Term {
        switch expression {
        case .aggregate(_):
    ...
    public func numericEvaluate(expression: Expression, result: SPARQLResult<Term>) throws -> NumericValue {
        switch expression {
        case .aggregate(_):
